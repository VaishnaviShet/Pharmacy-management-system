...
if($_SERVER['REQUEST_METHOD']=="POST"){
        ...
        $price = $_POST['price'];
        $count =$_POST['count'];
        $sql = "INSERT INTO `medicine` (`id`, `med_name`, `mtype_id`, `com_id`, `manu_date`, `exp_date`, `price`, `total_count`) VALUES (NULL, '$med_name', '$mtype_id', '$com_id', '$manu_date', '$exp_date', '$price', '$count')";
          ...
          Array.from(deletes).forEach((element) =>{
              element.addEventListener("click",(e)=>{
                  ...
                  if(confirm("Are you sure you want to delete this notes? ")){
                      console.log("yes");
                      window.location = `med.php?delete=${id}`;
                  }
                  else{
                      console.log("no");
                  }
